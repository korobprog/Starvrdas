    ...
    <div className="architecture-container">
      ...
      <main className="architecture-main">
        ...
        <ContentSection id="overview" title="Общий обзор">
          ...
          <Subsection title="Преимущества системы трансляции для заказчика">
            <p>
              Использование современной системы трансляции на базе Ant Media
              Server и WebRTC предоставляет заказчику ряд существенных
              преимуществ:
            </p>
            <ul>
              <li>
                <strong>Минимальная задержка</strong> - WebRTC обеспечивает
                задержку менее 1 секунды, что критично для интерактивных
                трансляций и живого общения со зрителями
              </li>
              <li>
                <strong>
                  Высокое качество при низком потреблении ресурсов
                </strong>{' '}
                - оптимизированные кодеки VP8/VP9 и H.264 обеспечивают отличное
                качество видео при меньшей нагрузке на сеть
              </li>
              <li>
                <strong>Гибкость настройки</strong> - возможность тонкой
                настройки параметров трансляции под конкретные нужды и условия
              </li>
              <li>
                <strong>Масштабируемость</strong> - система легко масштабируется
                от нескольких десятков до тысяч одновременных зрителей
              </li>
              <li>
                <strong>Мультиплатформенность</strong> - работает на всех
                современных браузерах и устройствах без необходимости установки
                плагинов
              </li>
              <li>
                <strong>Адаптивность к сетевым условиям</strong> -
                автоматическая подстройка качества в зависимости от пропускной
                способности канала зрителя
              </li>
              <li>
                <strong>Гибкая архитектура с WebRTC и Ant Media Server</strong>{' '}
                - позволяет создавать:
                <ul>
                  <li>Системы видеоконференций с множеством участников</li>
                  <li>
                    Интерактивные образовательные платформы с функцией
                    демонстрации экрана
                  </li>
                  <li>Решения для удаленного присутствия с низкой задержкой</li>
                  <li>
                    Гибридные системы вещания с ретрансляцией на популярные
                    платформы (YouTube, Rutube)
                  </li>
                  <li>Приватные трансляции с шифрованием данных</li>
                </ul>
              </li>
              <li>
                <strong>Экономическая эффективность</strong> - снижение затрат
                на инфраструктуру благодаря эффективным протоколам передачи
                данных
              </li>
              <li>
                <strong>Аналитика в реальном времени</strong> - детальный
                мониторинг качества трансляции и поведения зрителей
              </li>
              <li>
                <strong>Интеграция с существующими системами</strong> -
                возможность встраивания в любые веб-приложения и мобильные
                платформы
              </li>
              <li>
                <strong>
                  Ретрансляция в популярные стриминговые платформы
                </strong>{' '}
                - прямая передача трансляций в YouTube и Rutube с помощью Ant
                Media Server без необходимости дополнительного программного
                обеспечения
              </li>
            </ul>
          </Subsection>
        ...
        >
          <p>
            Пользовательский интерфейс платформы разделен на две основные части:
            веб-клиент для пользователей и административную панель для
            управления платформой.
          </p>

          <Subsection title="Веб-клиент">
            <p>
              Веб-клиент предоставляет пользователям доступ к просмотру стримов,
              управлению подписками и личному кабинету.
            </p>
            <MermaidDiagram chart={uiWebClientDiagram} />

            <Subsection title="Профиль пользователя">
              <ul>
                <li>Информация о пользователе (имя, фото профиля)</li>
                <li>Баланс кошелька</li>
                <li>Список активных подписок</li>
                <li>История просмотров</li>
                <li>Настройки профиля</li>
              </ul>
            </Subsection>

            <Subsection title="Кошелек">
              <ul>
                <li>Текущий баланс</li>
                <li>История транзакций</li>
                <li>Пополнение кошелька</li>
                <li>
            ...
            <Subsection title="Каталог мероприятий">
              <ul>
                <li>Список предстоящих мероприятий</li>
                <li>Фильтрация и поиск мероприятий</li>
                <li>Подписка на мероприятие с оплатой из кошелька</li>
              </ul>
            </Subsection>

            <Subsection title="Страница просмотра стрима">
              <ul>
                <li>Видеоплеер с адаптивным качеством</li>
                <li>Чат</li>
                <li>Кнопки для шеринга в социальные сети и мессенджеры</li>
              </ul>
            </Subsection>
          </Subsection>

          <Subsection title="Административная панель">
            <p>
              Административная панель предоставляет инструменты для управления
              платформой, пользователями, подписками и мероприятиями.
            </p>
            <MermaidDiagram chart={uiAdminPanelDiagram} />

            <Subsection title="Управление пользователями">
              <ul>
                <li>Просмотр списка пользователей</li>
                <li>Фильтрация и поиск пользователей</li>
                <li>Редактирование информации о пользователях</li>
                <li>Блокировка/разблокировка пользователей</li>
              </ul>
            </Subsection>

            <Subsection title="Управление подписками">
              <ul>
                <li>Просмотр активных подписок</li>
                <li>Создание и редактирование планов подписок</li>
                <li>Управление скидками и промокодами</li>
              </ul>
            </Subsection>

            <Subsection title="Управление мероприятиями">
              <ul>
            ...
            <Subsection title="Управление стримами">
              <ul>
                <li>Мониторинг активных стримов</li>
                <li>Управление настройками стримов</li>
                <li>Просмотр статистики стримов</li>
              </ul>
            </Subsection>

            <Subsection title="Аналитика">
              <ul>
                <li>Аналитика пользователей (регистрации, активность)</li>
                <li>Аналитика подписок (конверсия, доход)</li>
                <li>Аналитика платежей (транзакции, выручка)</li>
                <li>Аналитика стримов (просмотры, вовлеченность)</li>
                <li>Аналитика шеринга (социальные сети, конверсия)</li>
              </ul>
            </Subsection>
          </Subsection>
        </ContentSection>
        ...
        <ContentSection id="payment-systems" title="Платежные системы">
          ...
          <Subsection title="Компоненты пользовательского интерфейса для платежных систем">
            <ul>
              <li>
                <strong>Селектор платежного метода</strong> - компонент для
                выбора способа оплаты с учетом региона пользователя
              </li>
              <li>
                <strong>Форма платежа</strong> - адаптивная форма, меняющая свои
                поля в зависимости от выбранного платежного метода
              </li>
              <li>
                <strong>Виджет выбора валюты</strong> - позволяет пользователю
                выбрать предпочитаемую валюту для отображения цен
              </li>
              <li>
                <strong>Индикатор статуса платежа</strong> - отображает текущий
                статус платежа и шаги процесса оплаты
              </li>
              <li>
                <strong>Квитанция об оплате</strong> - генерирует и отображает
                информацию о совершенном платеже
              </li>
              <li>
                <strong>История платежей</strong> - компонент для отображения
                истории транзакций пользователя
              </li>
              <li>
                <strong>QR-код для оплаты</strong> - генерирует QR-код для
                быстрой оплаты через мобильные приложения (особенно актуально
                для UPI в Индии и СБП в России)
              </li>
              <li>
                <strong>Модальное окно подтверждения платежа</strong> -
                запрашивает подтверждение перед финализацией транзакции
              </li>
              <li>
                <strong>Компонент ввода данных карты</strong> - с поддержкой
                валидации и маскирования номера карты, срока действия и CVV
              </li>
              <li>
                <strong>Индикатор безопасности платежа</strong> - отображает
                информацию о безопасности транзакции и используемых протоколах
                шифрования
              </li>
            </ul>
          </Subsection>
        ...
        <ContentSection id="deployment" title="Развертывание и масштабирование">
          <Subsection title="Начальное развертывание">
            <ul>
              <li>Docker Compose для локальной разработки и тестирования</li>
              <li>
                Контейнеризация всех компонентов системы (NestJS, Ant Media
                Server, PostgreSQL, Redis)
              </li>
              <li>
                Автоматизация развертывания с помощью CI/CD (GitHub Actions или
                GitLab CI)
              </li>
            </ul>
          </Subsection>

          <Subsection title="Масштабирование в будущем">
            <ul>
              <li>Выделение модулей в отдельные микросервисы</li>
              <li>Использование API Gateway для маршрутизации запросов</li>
              <li>
                Горизонтальное масштабирование микросервисов при увеличении
                нагрузки
              </li>
              <li>Репликация базы данных для повышения производительности</li>
              <li>
                Использование Kubernetes для оркестрации контейнеров при росте
                системы
              </li>
            </ul>
          </Subsection>
